...
This module is required because multiple Phase 2 components import
`aegis_ai.company_brain.prescriptive_models.PrescriptiveSignal`.

Design constraints:
- No business logic.
- Conservative defaults.
- Import-safe for production boot.
"""
